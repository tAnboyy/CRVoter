...
//        db.execSQL("DROP TABLE Voter");
        db.execSQL("CREATE TABLE IF NOT EXISTS Voter(usn varchar(20) primary key,name varchar(25),phone varchar(10),voted int)");
    ...
    private void switchActivities() {
        Intent switchActivityIntent = new Intent(this, VOTE_PAGE.class);
